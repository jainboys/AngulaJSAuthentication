...
namespace AngularJSAuthentication.API.Helpers
{
    public class CommonHelper
    {
        ...
        /// <summary>
        /// checks whether the externelAccessToken and appId of the tiken is valid or not 
        /// </summary>
        ...
        public async Task<ParsedExternalAccessToken> VerifyExternalAccessToken(string provider, string accessToken)
        {
            ...
            if(Constant.DicVerifyTokenEndPoints.ContainsKey(provider))
            {
                string EndPointPath = Constant.DicVerifyTokenEndPoints[provider];
                verifyTokenEndPoint = string.Format(EndPointPath,accessToken);
            }
            else
                return null;
        ...
        public JObject GenerateLocalAccessTokenResponse(string userName)
        {
            ...
            var tokenExpiration = TimeSpan.FromMinutes(120);
